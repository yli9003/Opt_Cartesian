...
/**************************************************************************************************************************************************************/
  ...
  int BCPeriod, LowerPMLx, LowerPMLy, LowerPMLz;
  PetscOptionsGetInt(PETSC_NULL,"-BCPeriod",&BCPeriod,&flg);  MyCheckAndOutputInt(flg,BCPeriod,"BCPeriod","BCPeriod");
  PetscOptionsGetInt(PETSC_NULL,"-LowerPMLx",&LowerPMLx,&flg);  MyCheckAndOutputInt(flg,LowerPMLx,"LowerPMLx","LowerPMLx");
  PetscOptionsGetInt(PETSC_NULL,"-LowerPMLy",&LowerPMLy,&flg);  MyCheckAndOutputInt(flg,LowerPMLy,"LowerPMLy","LowerPMLy");
  PetscOptionsGetInt(PETSC_NULL,"-LowerPMLz",&LowerPMLz,&flg);  MyCheckAndOutputInt(flg,LowerPMLz,"LowerPMLz","LowerPMLz");
...
/**************************************************************************************************************************************************************/
  ...
  Vec munivpml;
  MuinvPMLGeneral(PETSC_COMM_SELF, &munivpml,Nx,Ny,Nz,Npmlx,Npmly,Npmlz,sigmax,sigmay,sigmaz,omega,LowerPMLx,LowerPMLy,LowerPMLz);
  double *muinv;
