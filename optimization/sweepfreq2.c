...
/**************************************************************************************************************************************************************/
  ...
  getint("-Jdir",&Jdir,0);
  if(Jdir==0){
    SourceSingleSetX(PETSC_COMM_WORLD, J, Nx, Ny, 1, cx, cy, cz, 1.0/hxyz);
  }else if(Jdir==1){
    SourceSingleSetY(PETSC_COMM_WORLD, J, Nx, Ny, 1, cx, cy, cz, 1.0/hxyz);
  }else{
    SourceSingleSetZ(PETSC_COMM_WORLD, J, Nx, Ny, 1, cx, cy, cz, 1.0/hxyz);
  }
  MatMult(D,J,b);
