...
int main(int argc, char **argv)
{
  ...
  makeRefField(maxwell1,flagparams,A,C,D,vR,ksp1,&its1, &refField1, &refField1conj, VecPt, inverse);
  MetaSurfGroup meta1={flagparams.Nx,flagparams.Ny,flagparams.Nz,flagparams.hxyz,epsSReal,epsFReal, maxwell1.omega, maxwell1.M, A, maxwell1.b, maxwell1.J, maxwell1.x, maxwell1.weightedJ, maxwell1.epspmlQ, maxwell1.epsbkg, maxwell1.epsdiff, maxwell1.epscoef, ksp1, &its1, metaphase, optsuperpose, refField1, refField1conj, VecPt, flagparams.outputbase, flagparams.filenameComm};
  ...
  if(Job==1){
    ...
    makeRefField(maxwell3,flagparams,A,C,D,vR,ksp3,&its3, &refField3, &refField3conj, VecPt, inverse);
    MetaSurfGroup meta3={flagparams.Nx,flagparams.Ny,flagparams.Nz,flagparams.hxyz,epsSReal,epsFReal, maxwell3.omega, maxwell3.M, A, maxwell3.b, maxwell3.J, maxwell3.x, maxwell3.weightedJ, maxwell3.epspmlQ, maxwell3.epsbkg, maxwell3.epsdiff, maxwell3.epscoef, ksp3, &its3, metaphase, optsuperpose, refField3, refField3conj, VecPt, flagparams.outputbase, flagparams.filenameComm};
    ...
    makeRefField(maxwell5,flagparams,A,C,D,vR,ksp5,&its5, &refField5, &refField5conj, VecPt, inverse);
    MetaSurfGroup meta5={flagparams.Nx,flagparams.Ny,flagparams.Nz,flagparams.hxyz,epsSReal,epsFReal, maxwell5.omega, maxwell5.M, A, maxwell5.b, maxwell5.J, maxwell5.x, maxwell5.weightedJ, maxwell5.epspmlQ, maxwell5.epsbkg, maxwell5.epsdiff, maxwell5.epscoef, ksp5, &its5, metaphase, optsuperpose, refField5, refField5conj, VecPt, flagparams.outputbase, flagparams.filenameComm};
