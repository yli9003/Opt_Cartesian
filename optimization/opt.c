...
if (Job==4){
  ...
  VecSet(J2,0.0);
  VecSet(J3,0.0);
  double *J1array,*J2array,*J3array;
  FILE *J1ptf,*J2ptf,*J3ptf;
  ...
  int inJi;
  PetscPrintf(PETSC_COMM_WORLD,"---reading J1, J2 and J3-----\n");
  for (inJi=0;inJi<6*Nxyz;inJi++)
    { 
  ...
  fclose(J2ptf);
  fclose(J3ptf);
  PetscPrintf(PETSC_COMM_WORLD,"---Done reading J2, J2 and J3!-----\n");
