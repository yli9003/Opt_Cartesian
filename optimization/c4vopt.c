...
/*-------------------------------------------------------------------------*/
  ...
  int Job;
  PetscOptionsGetInt(PETSC_NULL,"-Job",&Job,&flg); MyCheckAndOutputInt(flg,Job,"Job","Job (1 direct obj [SHG, singleldos, alpha, FOM] ; 2 minimax ; 3 gradient check [SHG, singleldos, alpha, ldosconstr, FOM])");
...
if (Job==1){
  ...
  int optjob;
  PetscOptionsGetInt(PETSC_NULL,"-optjob",&optjob,&flg);  MyCheckAndOutputInt(flg,optjob,"optjob","Job option (1 SHG, 2 Single freq, 3 Alpha, 4 FOM)");
...
if (Job==3){
  ...
  PetscOptionsGetInt(PETSC_NULL,"-optjob",&optjob,&flg);  MyCheckAndOutputInt(flg,optjob,"optjob","Job option (1 SHG, 2 Single freq, 3 Alpha, 4 LDOSconstr, 5 FOM)");
