...
/**************************************************************************************************************************************************************/
  ...
  double epsair1, epsair2, epsair3, epssub1, epssub2, epssub3;
  getreal("-epsair1",&epsair1,1);
  getreal("-epsair2",&epsair2,1);
  getreal("-epsair3",&epsair3,1);
...
/**************************************************************************************************************************************************************/
  ...
  GetMediumVecwithSub2(epsmedium1,Nz,Mz,epsair1,epssub1);
  GetMediumVecwithSub2(epsmedium2,Nz,Mz,epsair2,epssub2);
  GetMediumVecwithSub2(epsmedium3,Nz,Mz,epsair3,epssub3);
